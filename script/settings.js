Hooks.once('init', function() {
  game.settings.register('baskerville-ui', 'selectedStyle', {
    ...
    type: String,
    choices: {
      'style1.css': game.i18n.localize('baskerville-ui.settings.selectedStyle.choices.style1'),
      'style2.css': game.i18n.localize('baskerville-ui.settings.selectedStyle.choices.style2')
    },
    default: 'style1.css',
    onChange: value => {
